                ...
                <div className="form-wrapper">
                    ...
                    <form className="login-form">
                        ...
                        <div className="btnContainer">
                            <Link to="/home"><button className="btn1">Continue</button></Link> 
                        </div>
                        ...
                        <div className="foot-note">Don’t have an account? 
                            <Link to="/signIn" className="foot-link"> Create an account</Link>
                        </div>
                    </form>
                </div>
            </div>
